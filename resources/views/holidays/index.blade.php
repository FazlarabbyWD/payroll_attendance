...
<div class="card mt-4 ml-4 mr-4">
    <div class="row card-header mx-0 px-2">
        <div class="d-md-flex justify-content-between align-items-center dt-layout-start col-md-auto me-auto">
            <h5 class="card-title mb-0">Holiday Table</h5>
        </div>
            ...
            <div class="dt-buttons btn-group flex-wrap">
                <button class="btn create-new btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal"
                    ...
                    <span class="d-flex align-items-center">
                        ...
                        <span class="d-none d-sm-inline-block">Add New Holiday</span>
                    </span>
                </button>
            </div>
        </div>
    ...
    @include('holidays.partials.holiday_table', ['holidays' => $holidays])
